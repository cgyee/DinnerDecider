...
const AddressPage = () => {
  ...
  const onClick = async () => {
    console.log('🚀 ~ file: AddressPage.js ~ line 16 ~ onClick ~ zip', zipCode)
    ...
    history.push({ pathname: '/Vote/' + data.id }, { id: data.id })
  }
  return (
    <div
      className="container"
          ...
          <div className="row">
            <div className="d-grid gap-2 col-6 mx-auto">
              ...
              <button
                ...
                data-bs-target="#inviteOthersCollapse"
                aria-expanded="false"
                aria-controls="inviteOthersCollapse"
              >
                Invite Others?
              </button>
            </div>
            <div
              ...
              id="inviteOthersCollapse"
            >
              <div
                className="card card-body col-6"
